...
class ChatChat extends StatefulWidget {
  ...
  @override
  ChatChatState createState() => ChatChatState();
}

class ChatChatState extends State<ChatChat> {
        ...
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
                shape: BoxShape.rectangle, color: Color(0xFF333D56), borderRadius: BorderRadius.all(Radius.circular(15.0))),
            child: Row(
                  ...
                  child: Transform.rotate(
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        ...
                        onLongPress: () {
                          setState(() {
                            messageList.add(MessageData(textEditingController.text, false));
                            textEditingController.clear();
                            scrollAnimation();
                          });
                        },
